    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" >
      <ul class="nav navbar-nav navbar-right">
		...
		<li><a href="LogOut.py">LogOut</a></li>
				...
				<div class="text-center"><span class="fa fa-phone"></span>    Contact Management </div>
				</div>
				</div>
				</div>
...
cur=con.cursor()
cmd="select * from tblcontact";
cur.execute(cmd)
res=cur.fetchall()
for r in res:
	print "<tr><td>",r[1],"</td><td>",r[2],"</td><td>",r[3],"</td><td>",r[4],"</td><td>",r[5],"</td><td><a href='admincode/cdel.py?msg="+str(r[0])+"'><span class='fa fa-trash'></span></a></td></tr>"
print ("""
