...
<fieldset>
<form action="code/logincode.py" method="post">

<div class="h2 text-center"><span class="fa fa-sign-in"></span>  Log<b>In
</b></div>
...
<input type="text" class="form-control" placeholder="ENTER YOUR EMAIL.." name="email"></div>
<div class="h3">Password</div>
<div class="input-group">

<input type="password" id="input1" class="form-control" placeholder="ENTER YOUR PASSWORD..." name="pswd">
<span class="input-group-addon">
<span id="span1">Show</span></span>
</div><br/>
<a href="Changepassword.py"><span>Change Password??</span></a><br/><br/>
