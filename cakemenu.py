...
<div class="col-sm-12 banner">
			<div class="row">
				...
				<span class="bantxt">Delicious</span><br/>
				<span class="ban1txt">What You Need---We Have It </span>
				</div>
			</div>
			</div>
			<div class="col-sm-12 cake">
			<div class="row">
			<div class="text-center caketext">Cakes</div>
			<div class="col-sm-3 cake1">
			<div class="row">
			<div class="col-sm-12 acake1"></div>
			<div class="col-sm-12 acake2">
			<b style="color:white;font-size:20px;">Cake Name:-</b><span style="color:white;font-size:20px;">Chocolate Cake With Strawberry</span><br/>
			<b style="color:white;font-size:20px;">Cake Size:-</b><span style="color:white;font-size:20px;">1 Floor</span><br/>
			<b style="color:white;font-size:20px;">Cake Flavour:-</b><span style="color:white;font-size:20px;">Chocolate</span><br/>
			<b style="color:white;font-size:20px;">Cake Weight:-</b><span style="color:white;font-size:20px;">1Kg</span><br/>
			<b style="color:white;font-size:20px;">Cake Price:-</b><span style="color:white;font-size:20px;">Rs.650</span><br/>
			</div></div>
			</div>
			<div class="col-sm-3 cake1">
			<div class="row">
			<div class="col-sm-12 bcake1"></div>
			<div class="col-sm-12 bcake2">
			<b style="color:white;font-size:20px;">Cake Name:-</b><span style="color:white;font-size:20px;">Strawberry Cake</span><br/><br/>
			<b style="color:white;font-size:20px;">Cake Size:-</b><span style="color:white;font-size:20px;">1 Floor</span><br/>
			<b style="color:white;font-size:20px;">Cake Flavour:-</b><span style="color:white;font-size:20px;"> Strwaberry</span><br/>
			<b style="color:white;font-size:20px;">Cake Weight:-</b><span style="color:white;font-size:20px;">2Kg</span><br/>
			<b style="color:white;font-size:20px;">Cake Price:-</b><span style="color:white;font-size:20px;">Rs.650</span><br/>
			</div></div>
			</div>
			<div class="col-sm-3 cake1">
			<div class="row">
			<div class="col-sm-12 ccake1"></div>
			<div class="col-sm-12 ccake2"></div></div>
			</div>
			</div>
