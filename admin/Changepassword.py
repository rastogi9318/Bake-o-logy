    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" >
      <ul class="nav navbar-nav navbar-right">
		...
		<li><a href="LogOut.py">LogOut</a></li>
				...
				<div class="text-center"><span class="fa fa-phone"></span>  Change Password </div>
				</div></div>
				</div>
				</div>	</div>
				<div class="col-sm-6 change">
				
				<div class="text-center">CHANGE PASSWORD</div>
				<form action="admincode/cpasscode.py" method="post">
				<div class="h4">Old Password</div>
				<input type="password" name="opass" class="form-control">
				<div class="h4">Enter New Password</div>
				<input type="password" name="npass" class="form-control">
				<div class="h4">Confirm Password</div>
				<input type="password"name="cnpass" class="form-control">
				<br/>
				<input type="submit" value="Enter" class="form-control cbtn">
				</form>
				</div>
